...
namespace Mio_Rest_Api.Controllers
{
    ...
    public class CommentaireController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddCommentaire([FromBody] CommentaireDTO commentaireDTO)
        {
            try
            {
                var newCommentaire = await _serviceCommentaire.AddCommentaireAsync(commentaireDTO);
